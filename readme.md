...
- AdGuard Tracking Protection filter updated and removed 28 domains.
- AdGuard Tracking Protection filter — first-party trackers updated and removed 3 domains.
- AdGuard DNS filter updated and added 23 domains.
- AdGuard Chinese filter updated and removed 1 domains.
- AdGuard Russian filter updated and removed 1 domains.
...
- EasyList adservers updated and added 20 domains.
- EasyList adservers popup updated and removed 1 domains.
- EasyPrivacy updated and removed 30 domains.
- EasyPrivacy specific updated and removed 1 domains.
- oisd small updated and removed 30 domains.
- oisd nsfw small updated and removed 581 domains.
- Sinfonietta's pornography-hosts updated and removed 29 domains.
- someonewhocares updated and removed 7 domains.
- Unified hosts, fakenews and gambling updated and removed 160 domains.
- URLhaus updated and added 3 domains.
- RU Adlist updated and removed 5 domains.
- hostsVN updated and removed 1 domains.
- scamblocklist updated and removed 2 domains.
- uBlock₀ filters – Badware risks updated and removed 4 domains.
- Red Flag Domains updated and removed 53 domains.
- Ultimate Ad Filter updated and removed 8 domains.
- Ultimate Privacy Filter updated and removed 28 domains.
- Malware and Phishing Blocklist updated and removed 38 domains.
- Emerging Threats PiHole (MALICIOUS) updated and removed 4 domains.
- Phishing Army (Extended) updated and removed 20 domains.
- Phishing URL Blocklist updated and added 797 domains.
- Zonefiles Compromised domains updated and removed 8 domains.
- USOM list updated and removed 326 domains.
- oisd big updated and removed 354 domains.
- Matomo Referrer Spam List updated and removed 3 domains.
- anti-AD updated and removed 410 domains.
- HaGeZi's NSFW DNS Blocklist updated and removed 10 domains.
- Dandelion Sprout's Anti-Malware List  updated and removed 1,474 domains.
- HaGeZi's Pro mini DNS/Browser Blocklist updated and removed 68 domains.
- uniartisan's Adblock List Plus updated and removed 33 domains.
