...
- AdAway updated and removed 2 domains.
- AdGuard Base filter updated and added 1 domains.
- AdGuard Mobile Ads filter updated and removed 1 domains.
- AdGuard Tracking Protection filter updated and removed 14 domains.
- AdGuard Tracking Protection filter — third-party trackers updated and removed 1 domains.
- AdGuard Tracking Protection filter — first-party trackers updated and removed 1 domains.
- AdGuard DNS filter updated and removed 173 domains.
- AdGuard Chinese filter updated and added 35 domains.
- AdGuard Russian filter updated and removed 3 domains.
- AdGuard Japanese filter updated and removed 2 domains.
- AdGuard French filter updated and removed 2 domains.
- DigitalSide Threat-Intel updated and removed 1 domains.
- EasyList updated and removed 8 domains.
- EasyList adservers updated and removed 6 domains.
...
- EasyList China updated and removed 176 domains.
- oisd small updated and added 24 domains.
- oisd nsfw small updated and added 62 domains.
- NoTrack Tracker Blocklist updated and removed 1 domains.
- Sinfonietta's pornography-hosts updated and removed 25 domains.
- someonewhocares updated and removed 7 domains.
- Hosts contributed by Steven Black updated and removed 1 domains.
- Unified hosts, fakenews and gambling updated and removed 165 domains.
- pgl.yoyo.org updated and added 4 domains.
- URLhaus updated and added 6 domains.
- RU Adlist updated and removed 13 domains.
- hostsVN updated and removed 1 domains.
- uBlock₀ filters – Badware risks updated and added 3 domains.
- uBlock₀ filters – Ads updated and removed 1 domains.
- Red Flag Domains updated and removed 79 domains.
- Ultimate Ad Filter updated and removed 16 domains.
- Ultimate Privacy Filter updated and removed 15 domains.
- Malware and Phishing Blocklist updated and removed 46 domains.
- Emerging Threats PiHole (MALICIOUS) updated and removed 5 domains.
- Phishing Army (Extended) updated and removed 427 domains.
- Phishing URL Blocklist updated and removed 441 domains.
- Zonefiles Compromised domains updated and removed 10 domains.
- USOM list updated and removed 246 domains.
- oisd big updated and added 377 domains.
- Matomo Referrer Spam List updated and removed 9 domains.
- anti-AD updated and removed 1,152 domains.
- HaGeZi's NSFW DNS Blocklist updated and added 1,383 domains.
- Dandelion Sprout's Anti-Malware List  updated and removed 1,374 domains.
- HaGeZi's Pro mini DNS/Browser Blocklist updated and removed 267 domains.
- a.dove.is.dumb updated and added 1 domains.
- uniartisan's Adblock List Plus updated and removed 37 domains.
